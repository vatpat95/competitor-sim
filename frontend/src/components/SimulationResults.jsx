          ...
          <div className="space-y-3">
            {Object.entries(out.playerOutcomes).map(([key, val]) => (
              ...
              >
                ...
                {/* Reasoning — generated by AI but previously hidden for competitors */}
                {val.reasoning && (
                  <p className="text-xs text-gray-400 leading-relaxed">{val.reasoning}</p>
                )}
                {/* Financial estimate — new field, amber to signal it's a projection */}
...
export default function SimulationResults({ result, yourCompany, rawCompetitors }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <PriorityActionsPanel actions={out.priorityActions} />
